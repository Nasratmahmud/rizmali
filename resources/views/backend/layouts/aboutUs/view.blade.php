                ...
                <table class="display" id="basic-1">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><img src="{{ asset($aboutUs->photo) }}" alt="Image" width="150px">
                            </td>
                            <td> 
                            <ul class="action"> 
                                <li class="edit" > <a href="{{route('aboutus.edit',['id' => $aboutUs->id])}}"><i class="icon-pencil-alt"></i></a></li>
                                <li class="delete delete-btn" data-id="{{ $aboutUs->id }}"><a href="#"><i class="icon-trash"></i></a></li>
                            </ul>
                            </td>
                            @endif
